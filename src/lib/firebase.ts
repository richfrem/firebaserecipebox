...
import { getAuth, GoogleAuthProvider, AppleAuthProvider, MicrosoftAuthProvider } from "firebase/auth";
...
export { app, storage, db, auth, googleProvider, appleProvider, microsoftProvider };
